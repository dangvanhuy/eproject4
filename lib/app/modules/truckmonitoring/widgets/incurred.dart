...
import 'package:eproject/app/modules/truckmonitoring/widgets/chart_incurred.dart';
...
class Incurred extends BaseView<TruckmonitoringController> {
  const Incurred({Key? key}) : super(key: key);
  ...
  Widget buildView(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Phí phát sinh'),
        centerTitle: true,
        actions: [
