...
class CommandDriverView extends BaseView<CommandDriverController> {
  const CommandDriverView({Key? key}) : super(key: key);
  @override
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              Get.offAllNamed(Routes.RECEIVED_ODERS);
                            },
                            child: Text("Nhận lệnh"),
                          ),
                        ],
                      ),
                    ],
